...
{
    public const FIRST_PAGE_SLIDES = 1;
    public const LAST_PAGE_SLIDES = 1;
    ...
    public function get()
    {
        ...
        if ($this->paginator->lastPage() < ($onEachSide * 2) + $this->getExtraSlides()) {
    ...
    {
        $window = $onEachSide + $this->getExtraSlides();
    ...
    {
        return $this->paginator->getUrlRange(1, self::FIRST_PAGE_SLIDES);
    }
    ...
    {
        return $this->paginator->getUrlRange(
            $this->lastPage() - (self::LAST_PAGE_SLIDES - 1),
            $this->lastPage()
        );
    }
     ...
     * @return int
     */
    private function getExtraSlides()
    {
        return self::FIRST_PAGE_SLIDES + self::LAST_PAGE_SLIDES;
    }
}
